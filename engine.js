...
function _mzFallbackLigneeOr(containerId) {
  ...
  var h = '';
  h += '<div id="mz-isnad-container" style="min-height:40px;padding:14px 20px 10px;background:linear-gradient(165deg,rgba(10,6,0,.92),rgba(8,5,0,.95));">';
  ...
  GIANTS.forEach(function(g, i) {
    h += '<div style="display:flex;align-items:center;gap:10px;padding:7px 10px;background:rgba(212,175,55,.04);border:1px solid rgba(212,175,55,.12);border-radius:6px;">';
